import { createBook, getAllBooks, getOneBook, deleteOneBook, updateOneBook } from "../controllers/book.controller.js";
...
router.route('/book/updateOne/:id').patch(updateOneBook)
